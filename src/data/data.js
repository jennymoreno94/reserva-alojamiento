...
import bambaAreco from "../data/images/la-bamba-de-areco.jpg";
import sainteJeanne from "../data/images/sainte-jeanne.jpg";
import entreCielos from "../data/images/entre-cielos.jpg";
import huacalera from "../data/images/huacalera.jpg";
import mercedAlto from "../data/images/merced-del-alto.jpg";
import azurReal from "../data/images/azur-real.jpg";
import rinconSocorro from "../data/images/rincon-del-socorro.jpg";
import lumaMontana from "../data/images/luma-casa-de-montana.jpg";
import casaTurquesa from "../data/images/casa-turquesa.jpg";
import vilaSanta from "../data/images/vila-da-santa.jpg";
import uxuaCasa from "../data/images/uxua-casa.jpg";
import pontaDos from "../data/images/ponta-dos-ganchos.jpg";
import altoAtacama from "../data/images/alto-atacama.jpg";
import tierraPatagonia from "../data/images/tierra-patagonia.jpg";
import vira from "../data/images/vira-vira.jpg";
import vikChile from "../data/images/vik-chile.jpg";
import casaHigueras from "../data/images/casa-higueras.jpg";
import campoTinto from "../data/images/campo-tinto.jpg";
